...
public class TinyWorldPhotoTreeLayer extends RenderableLayer implements SelectListener, IndexorListener {
    ...
    public void selected(SelectEvent event) {
        ...
        // logger.debug(event.getTopPickedObject() != null && event.getTopPickedObject().getParentLayer() !=
        // null ? event.getTopPickedObject().getParentLayer().getName() : "No Parent Layer");
        ...
        case SelectEvent.LEFT_CLICK:
            ...
            if (node.isLeaf()) {
                ...
                // Update node selection status but also force its parent's one as there may be some discrepancies
                // in some cases
    ...
    protected void initialize() {
        ...
        /*
         * BasicTreeNode child = new BasicTreeNode("Child 1", ICON_PATH); child.setDescription("This is a child node");
         * child.addChild(new BasicTreeNode("Subchild 1,1")); child.addChild(new BasicTreeNode("Subchild 1,2"));
         * child.addChild(new BasicTreeNode("Subchild 1,3", ICON_PATH)); root.addChild(child);
         *
         * child = new BasicTreeNode("Child 2", ICON_PATH); child.addChild(new BasicTreeNode("Subchild 2,1"));
         * child.addChild(new BasicTreeNode("Subchild 2,2")); child.addChild(new BasicTreeNode("Subchild 2,3"));
         * root.addChild(child);
         *
         * child = new BasicTreeNode("Child 3"); child.addChild(new BasicTreeNode("Subchild 3,1")); child.addChild(new
         * BasicTreeNode("Subchild 3,2")); child.addChild(new BasicTreeNode("Subchild 3,3")); root.addChild(child);
         */
