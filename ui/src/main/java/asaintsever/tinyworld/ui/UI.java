...
public class UI {
    ...
    // Must declare JUL loggers as static to make sure they are not garbage collected (by
    ...
    protected static java.util.logging.Logger flatlafJULlogger = java.util.logging.Logger
            .getLogger(com.formdev.flatlaf.FlatLaf.class.getName());
    ...
    static {
        ...
        if (gov.nasa.worldwind.Configuration.isMacOS()) {
            ...
            System.setProperty("apple.awt.brushMetalLook", "true");
                ...
                || (gov.nasa.worldwind.Configuration.isLinuxOS() && System.getProperty("os.version") != null
    ...
    protected static MainFrame start(String appName, Configuration cfg) throws Exception {
        ...
        if (logger.isDebugEnabled()) {
            ...
            for (GraphicsDevice gd : GraphicsEnvironment.getLocalGraphicsEnvironment().getScreenDevices()) {
                ...
                logger.debug("[Screen id " + gd.getIDstring() + "] Detected Screen Size: " + screenArea.width + "x"
                        + screenArea.height); // Beware: won't return "real" size if High DPI scaling is in use
